<%@page import="cl.awakelab.prevencion.model.entity.Administrativo"%>
...
<html>
	...
	<body>
		...
		<div class="container mt-5">
			<div class="row">
				<h1 class="text-center">Listado Administrativos</h1>
				...
				<div>
			      ...
			      <table class="table table-striped table-hover">
			        ...
			        <!-- row = fila -->
			 		...
			 		<% List<Administrativo> usuarios = (List<Administrativo>)request.getAttribute("usuarios"); 
			 			if(usuarios != null ) {	
			 				
			 			 for(Administrativo user: usuarios) { 
			        ...
			        <tr>
			          ...
			          <td><%=user.getArea()%></td>
			          <td><%=user.getExperienciaPrevia()%></td>		          
